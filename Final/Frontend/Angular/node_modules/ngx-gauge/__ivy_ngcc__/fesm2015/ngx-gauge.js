...
NgxGauge.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgxGauge, selectors: [["ngx-gauge"]], contentQueries: function NgxGauge_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgxGaugeLabel, 1);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgxGaugePrepend, 1);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgxGaugeAppend, 1);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgxGaugeValue, 1);
    } if (rf & 2) {
        let _t;
...
NgxGaugeModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule]] });
