...
export declare class IgxGridToolbarComponent extends DisplayDensityBase implements OnInit, OnDestroy {
    ...
    /** @hidden @internal */
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<IgxGridToolbarComponent, [{ optional: true; }, null, null, null]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<IgxGridToolbarComponent, "igx-grid-toolbar", never, { "showProgress": "showProgress"; "grid": "grid"; }, {}, ["hasTitle", "hasActions"], ["[igxGridToolbarTitle],igx-grid-toolbar-title", "*", "[igxGridToolbarActions],igx-grid-toolbar-actions"]>;
}
