...
export declare const getProjectPaths: (config: WorkspaceSchema, appendPrefix?: boolean) => string[];
export declare const getWorkspacePath: (host: Tree) => string;
export declare const getWorkspace: (host: Tree) => WorkspaceSchema;
export declare const getProjects: (config: WorkspaceSchema) => WorkspaceProject<ProjectType.Application>[];
