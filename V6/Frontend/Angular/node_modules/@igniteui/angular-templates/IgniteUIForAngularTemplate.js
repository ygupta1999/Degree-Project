...
class IgniteUIForAngularTemplate {
    ...
    getBaseVariables(name) {
        ...
        config["igxPackage"] = package_resolve_1.resolveIgxPackage(package_resolve_1.NPM_PACKAGE);
        config["dockManagerPackage"] = package_resolve_1.resolveIgxPackage(package_resolve_1.NPM_DOCK_MANAGER);
