...
export declare class DefaultSortingStrategy implements ISortingStrategy {
    ...
    protected compareObjects(obj1: any, obj2: any, key: string, reverse: number, ignoreCase: boolean, valueResolver: (obj: any, key: string, isDate?: boolean) => any, isDate: boolean): number;
