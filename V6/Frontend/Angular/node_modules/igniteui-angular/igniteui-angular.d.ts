...
export { IgxTemplateOutletDirective as ɵdi, IgxTemplateOutletModule as ɵdj } from './lib/directives/template-outlet/template_outlet.directive';
...
export { IgxGridFilteringCellComponent as ɵcw } from './lib/grids/filtering/base/grid-filtering-cell.component';
export { IgxGridFilteringRowComponent as ɵdh } from './lib/grids/filtering/base/grid-filtering-row.component';
...
export { IgxRowEditActionsDirective as ɵdm, IgxRowEditTabStopDirective as ɵdn, IgxRowEditTemplateDirective as ɵdk, IgxRowEditTextDirective as ɵdl } from './lib/grids/grid.rowEdit.directive';
...
export { IgxGridHeaderGroupComponent as ɵct } from './lib/grids/headers/grid-header-group.component';
export { IgxGridHeaderComponent as ɵcu } from './lib/grids/headers/grid-header.component';
...
export { IgxColumnResizerDirective as ɵcz } from './lib/grids/resizing/resizer.directive';
export { IgxColumnResizingService as ɵcv } from './lib/grids/resizing/resizing.service';
export { IgxDragIndicatorIconDirective as ɵde, IgxRowDragDirective as ɵdd, IgxRowDragGhostDirective as ɵdf, IgxRowDragModule as ɵdg } from './lib/grids/row-drag.directive';
export { IgxGridDragSelectDirective as ɵfh } from './lib/grids/selection/drag-select.directive';
export { IgxGroupByRowSelectorDirective as ɵdb, IgxHeadSelectorDirective as ɵdc, IgxRowSelectorDirective as ɵda } from './lib/grids/selection/row-selectors';
