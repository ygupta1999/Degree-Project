...
export declare class IgxBannerComponent implements IToggleView {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<IgxBannerComponent, "igx-banner", never, { "animationSettings": "animationSettings"; }, { "onOpened": "onOpened"; "onOpening": "onOpening"; "onClosed": "onClosed"; "onClosing": "onClosing"; }, ["bannerIcon", "_bannerActionTemplate"], ["igx-icon", "*", "igx-banner-actions"]>;
}
/**
 * @hidden
 */
export declare class IgxBannerModule {
    static ɵfac: ɵngcc0.ɵɵFactoryDef<IgxBannerModule, never>;
