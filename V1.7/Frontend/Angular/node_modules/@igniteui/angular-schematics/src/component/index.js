...
function addComponent(options, skipRoute = false, modulePath) {
    return (tree, _context) => __awaiter(this, void 0, void 0, function* () {
        ...
        return schematics_1.chain([...options.templateInst.templatePaths.map(templatePath => schematics_1.mergeWith(schematics_1.apply(schematics_1.url(cli_core_1.Util.relativePath(__filename, templatePath, true)), [
    ...
    return (tree, context) => __awaiter(this, void 0, void 0, function* () {
        ...
        return schematics_1.chain([
            ...
            (_host, _context) => {
                ...
                else if (_host.actions.find(x => x.path === core_1.normalize("/package.json") && x.kind === "o")) {
