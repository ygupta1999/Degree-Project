...
export class RestApiService {
  ...
  testProd = {
    author: "zvDRU1bQ0uNJTupmjnRt10MktYF3",
  }
  ...
  httpOptions = {
    ...
    postProduction(){
      ...
      return this.http.post(this.serverURLV17 + '/solar_production', this.testProd)
      //TODO
    ...
    ///THIS IS BIDDDDDDDD
    postConsumption(){
      return this.http.post(this.serverURLV17 + '/solar_consumption', this.testProd)
    }
    ...
    if(this.currentUid = "") 
    {
      this.testProd.author = "zvDRU1bQ0uNJTupmjnRt10MktYF3";
    } 

      return this.http.post(this.serverURLV17 + '/surplus',  this.testProd)
    }
