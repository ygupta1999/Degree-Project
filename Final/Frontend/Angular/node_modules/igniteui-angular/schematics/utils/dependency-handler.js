...
exports.getConfigFile = (project, option, context, configSection = 'build') => {
...
exports.overwriteJsonFile = (tree, targetFile, data) => tree.overwrite(targetFile, JSON.stringify(data, null, 2) + '\n');
// eslint-disable-next-line @typescript-eslint/no-unused-vars
exports.logSuccess = (options) => (tree, context) => {
    context.logger.info('');
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
exports.addDependencies = (options) => (tree, context) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.propertyExistsInWorkspace = (targetProp, workspace) => {
...
exports.getPropertyFromWorkspace = (targetProp, workspace, curKey = '') => {
...
exports.addPackageToPkgJson = (tree, pkg, version, target) => {
